...
import fs8, { lstatSync, rmSync, unlinkSync, rmdirSync, renameSync, readdirSync as readdirSync$1, chmodSync, statSync } from 'fs';
...
var mkdir = (path9, options) => new Promise((res, rej) => fs8.mkdir(path9, options, (er, made) => er ? rej(er) : res(made)));
